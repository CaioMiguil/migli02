...
import { X, RotateCcw, Smartphone, Check, AlertTriangle } from 'lucide-react'
...
function ScanHUD({ scan, camera, onClose }) {
  const { state, start, finishEarly, cancel } = scan
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        {phase === ScanPhase.IDLE && (
          <IdleOverlay key="idle" onStart={start} />
        )}
      ...
      >
        ...
        <div className="mx-auto max-w-md rounded-3xl border border-white/[0.08] bg-black/65 p-5 backdrop-blur-xl">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3 text-center">
            ...
            <Metric label="Cobertura" value={`${Math.round(state.coverage * 100)}%`} />
