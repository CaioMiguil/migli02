...
export const CAPTURE_COPY = {
  permissionTitle: 'Pronto para capturar?',
  permissionBody:
    'A MIGLI precisa acessar sua câmera para criar o tour imersivo. Seu vídeo fica no seu aparelho até você decidir publicar.',
  permissionDenied:
    'O acesso à câmera foi bloqueado. Libere nas configurações do navegador e recarregue a página.',
  permissionUnavailable:
    'Este navegador não suporta captura de vídeo. Abra o MIGLI no Safari ou Chrome em um celular moderno.',
  cta: 'Liberar câmera',
